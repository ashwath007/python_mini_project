...
#x=int(input("Enter the year to view the event : "))
print(calendar.calendar(2018)) 
#from tkMessageBox import *
root = Tk()
labelfont = ('times', 20, 'bold')
widget = Label(root, text='SKCET Event App')
...
#c=calendar.month(2018,2)
#e=Label(root, text=c)
#e=Label(root, text='cal')
class Calendar:
...
w1 = Label(root, text='Select the options below')
w1.config(underline=33)
w1.config(bg="white", fg='blue')
w1.pack()
frame = Frame(root)
frame.pack()
...
c=calendar.month(2018,10)
print("--------------SKCET ICT YOUTH TALK ----------\n",end=("  "))
l=["Skcet SCIENCE PROJECT EXPO","Language Club Function 2019","ICT Youth Talk","2019 IT-Expo","Culturals 2019"]
